...
São inspecionados metadados, número de amostras e conteúdo integral do WAV; os chunks
PCM precisam ser consecutivos, sem duplicação, no formato informado. O limite é
30 minutos de áudio. A cauda inferior a um frame não entra na contagem de VAD.
Dependência ausente ou erro do detector é falha explícita, sem aprovação automática.
...
sintético determinístico. Para testar fronteiras de duração, níveis de amplitude e
